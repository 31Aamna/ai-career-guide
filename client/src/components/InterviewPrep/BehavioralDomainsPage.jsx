...
import { behavioralDomains } from '../../data/interviewData';

// Component name should be PascalCase
const BehavioralDomainsPage = ({ onSelectDomain, onBack }) => {
  return (
    <div>
      <div style={{textAlign:'center', marginBottom:'40px'}}>
        <h2 style={{fontSize:'28px', color:'var(--text-main)'}}>Behavioral Domains</h2>
        <p style={{color:'var(--text-light)'}}>Select a skill to practice</p>
      </div>
...
export default BehavioralDomainsPage;
